...
<html>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo (ADMIN_PUBLIC); ?>/css/manhuaDate.1.0.css">
								...
								<div class="ibox-content">
									<form method="post" class="form-horizontal" enctype="multipart/form-data">
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" name="an_title"  placeholder="必填"  required="" class="form-control">
											</div>
										</div>
                                        ...
                                        <!--<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" name="an_summary" placeholder="选填" class="form-control">
											</div>
										</div>-->
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" name="an_author" value="管理员" placeholder="选填" class="form-control">
											</div>
										</div>
