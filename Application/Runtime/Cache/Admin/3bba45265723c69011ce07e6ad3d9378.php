		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					...
					<div class="col-lg-3">
						<h2></h2>
						<a class="btn btn-primary" href="/food/index.php/Admin/Student/add">返回</a>
					</div>
				</div>
				<div class="wrapper wrapper-content animated fadeInRight">
					<div class="row">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($listArray)): $i = 0; $__LIST__ = $listArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($i); ?></td>
                    ...
                    <div class="col-lg-1 col-lg-offset-11">
						<a class="btn btn-primary" href="/food/index.php/Admin/Student/add">返回添加</a>
					</div>
					</div>
					</div>
					</div>
