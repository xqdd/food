                    ...
                    <div class="ibox-content">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php if(is_array($arrayList)): $i = 0; $__LIST__ = $arrayList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td class="text-center"><?php echo ((($p - 1) * 20) + $i); ?></td>
                                <td class="text-center" width="30%"><?php echo ($vo["an_title"]); ?></td>  
                                <td class="text-center"><?php echo (date('Y-m-d',$vo["an_create_time"])); ?></td>
                                <td class="text-center" width="30%"><?php echo ($vo["an_summary"]); ?></td>
                                <td class="text-center"><a href="/food/index.php/Admin/Announce/deleteSingle/singleID/<?php echo ($vo["an_id"]); ?>"
                                	onclick="javascript:return confirm('你确定要删除《<?php echo ($vo["an_title"]); ?>》这份公告吗?')" class="btn btn-warning">删除</a></td>
