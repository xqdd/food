	...
	<nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
		...
		<ul class="nav navbar-top-links navbar-right">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <form action='/food/index.php/Admin/Content/search' class="form-horizontal" method="post">
                	<h2></h2>
                    	<div class="col-md-2">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php if(is_array($arrayList)): $i = 0; $__LIST__ = $arrayList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a href="/food/index.php/Admin/Content/showByID/ct_id/<?php echo ($vo["ct_id"]); ?>"><?php echo ($vo["ct_name"]); ?></a></td>  
                                <td><?php echo ($vo["ct_teacher"]); ?></td>
                                <td class="text-center">
                                	<p>
							      <?php if($vo["ct_seletctd_num"] == 1): ?><span style="color:red;font-size:16px;">已选</span>
							      <?php else: ?>
							      <span style="color:green;font-size:16px">未选</span><?php endif; ?>
							      </p>
							      </td>
                        ...
                        <a href="/food/index.php/Admin/Content/expExcel" class="btn btn-primary" style="margin-left: 80%;">获取所有未被选课题列表</a>
