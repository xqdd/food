...
<div class="row border-bottom">
							...
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
									...
									<form method="post" class="form-horizontal" enctype="multipart/form-data">
										<input type="hidden" name="sd_id" value="<?php echo ($list["sd_id"]); ?>">
										<div class="form-group">
											<label class="col-sm-4 control-label">学号:</label>
											<div class="col-sm-3">
												<input type="text" name="sd_num" value="<?php echo ($list["sd_num"]); ?>" class="form-control">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" name="sd_name" value="<?php echo ($list["sd_name"]); ?>" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<div class="hr-line-dashed"></div>
											...
											<div class="col-sm-3">
												<input type="text" name="sd_sex" value="<?php echo ($list["sd_sex"]); ?>" class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" name="sd_political_status" value="<?php echo ($list["sd_political_status"]); ?>" class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" name="sd_nation" value="<?php echo ($list["sd_nation"]); ?>" class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" name="sd_professional" value="<?php echo ($list["sd_professional"]); ?>" class="form-control">
											</div>
										</div>
										<div class="form-group">
											
											<div class="hr-line-dashed"></div>
											<label class="col-sm-4 control-label">班别:</label>
											<div class="col-sm-3">
												<input type="text" name="sd_class" value="<?php echo ($list["sd_class"]); ?>" class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" name="sd_idcar" value="<?php echo ($list["sd_idcar"]); ?>" class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" name="sd_pwd" value="<?php echo ($list["sd_pwd"]); ?>" class="form-control">
											</div>
										</div>
	...
	<script type="text/javascript" charset="utf-8" src="<?php echo (ADMIN_UEDITOR); ?>/ueditor.config.js"></script>
	<script type="text/javascript" charset="utf-8" src="<?php echo (ADMIN_UEDITOR); ?>/ueditor.all.min.js">
	</script>
	<script type="text/javascript">
	navbar('.header_article_li','.open_article_li');
		 //实例化编辑器
		...
		editor.addListener("ready", function() {
			// editor准备好之后才可以使用
			editor.setContent(atc_content.innerHTML);
		});
	</script>
<script type="text/javascript">
        	navbar('.edit_li','.edit_li1');
    </script>
</html>