	...
	<nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
		...
		<ul class="nav navbar-top-links navbar-right">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-3">
                    <h2></h2>
                    <a class="btn btn-primary"  href="/food/index.php/Admin/Manager/add/mg_sign/<?php echo ($whatNum); ?>" >添加</a>
                </div>
            </div>
            
    <script type="text/javascript">
    /*删除图片*/
    function ajax_pic(valueDel){
     if(confirm('你确认要删除吗？')){
             $.ajax({
     "type":'GET',
     "url": "/food/index.php/Admin/Manager/delete?valueDel="+valueDel, 
     "date":'ok?',
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="wrapDel<?php echo ($vo["mg_id"]); ?>">
                                <td><?php echo ($i); ?></td>
                                <td><?php echo ($vo["mg_name"]); ?></td>
                                <td><?php echo ($vo["mg_pwd"]); ?></td>
                                <td>
                        <span class="btn btn-warning btn-xs" value="<?php echo ($vo["mg_id"]); ?>"
                        onclick="ajax_pic(<?php echo ($vo["mg_id"]); ?>);">删除</span>                                </td>
