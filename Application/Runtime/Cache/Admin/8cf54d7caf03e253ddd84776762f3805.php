...
<div class="row border-bottom">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong class="breadcrumb_li3">删除课题内容</strong>
                        </li>
                    </ol>
                </div>
    ...
    <script type="text/javascript">
    function ajax_pic(valueDel,studentNum){
     if(studentNum == 0){
     if(confirm('你确认要删除吗？')){
     	
     $.ajax({
     type :'GET',
     url : "/food/index.php/Admin/content/deleteIndex", 
     data: {"valueDel":valueDel},
     dataType: "json",
     success: function(msg){
        if(msg == 1){
        	//alert('删除成功');
           $("#wrapDel"+valueDel).remove();
        }else{
           alert('删除失败');
        }
      }});
     	...
     	alert('已经有'+studentNum+'人选课了,不能删除！');
     	return ;
     }
    }
    </script>      
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($arrayList)): $i = 0; $__LIST__ = $arrayList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="wrapDel<?php echo ($vo["ct_id"]); ?>">
                                <td><?php echo ($i); ?></td>
                                <td><?php echo ($vo["ct_name"]); ?></td>  
                                <td><?php echo ($vo["ct_teacher"]); ?></td>
                                <td><?php echo ($vo["ct_seletctd_num"]); ?></td>
                                <td>
                                	<span class="btn btn-warning btn-xs" value="<?php echo ($vo["ct_id"]); ?>" onclick="ajax_pic(<?php echo ($vo["ct_id"]); ?>,<?php echo ($vo["ct_seletctd_num"]); ?>);">删除</span>
                                </td>
...
<?php echo ($page); ?>
                    ...
                    <a href="/food/index.php/Admin/Content/deleteAll/deleteAll/999" 
									class="col-lg-1 col-lg-offset-1 btn btn-warning deleteWhole" onclick="javascript:return confirm('!!!你确定要删除所有课题吗？')">删除所有课题</a>
                </div>
            </div>
        </div>
        </div>
