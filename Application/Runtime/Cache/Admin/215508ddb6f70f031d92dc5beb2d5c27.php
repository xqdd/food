...
<div class="row border-bottom">
			...
			<li>
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                    	...
                    	<form action='/food/index.php/Admin/Student/delete' class="form-horizontal" method="post">
                    	<div class="col-md-4">
                    		<input type="text" name="sd_class" placeholder="按班级查找"class="form-control" required="">
                    	</div>
                    	<div class="col-md-2">
				...
				<div class="wrapper wrapper-content animated fadeInRight">
					...
					<table class="table table-striped table-bordered table-hover">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($i); ?></td>
                                <td><?php echo ($vo["sd_num"]); ?></td>  
                                <td><?php echo ($vo["sd_name"]); ?></td>
                                <td><?php echo ($vo["sd_sex"]); ?></td>
                                <td><?php echo ($vo["sd_political_status"]); ?></td>  
                                <td><?php echo ($vo["sd_nation"]); ?></td>
                                <td><?php echo ($vo["sd_professional"]); ?></td>
                                <td><?php echo ($vo["sd_class"]); ?></td>  
                                <td><?php echo ($vo["sd_idcar"]); ?></td>
                                <td><?php echo ($vo["sd_pwd"]); ?></td>
                                <td><a href="/food/index.php/Admin/Student/deleteSingle/singleID/<?php echo ($vo["sd_id"]); ?>"
                                	class="btn btn-warning" onclick="javascript:return confirm('你确定要删除&nbsp;&nbsp;<?php echo ($vo["sd_name"]); ?>&nbsp;&nbsp;吗?')">删除</a></td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                        </table>
								</div>
								<div>
								<input type="hidden" value="<?php echo ($marksClass); ?>" class="marksClass" />
								
								<form method="get" action="/food/index.php/Admin/Student/deleteClass">
									<input type="hidden" value="<?php echo ($list[0]["sd_class"]); ?>" name="sd_class"/>
									<input type="submit" value="确认删除整班" onclick="return confirm('您确定进行此操作？？删除整班后数据不可恢复，请三思而后行！！！')"  class="col-lg-1 col-lg-offset-1 btn btn-warning deleteWhole" />
								</form>
								
								
								<!--<a style="display:none;" href="/food/index.php/Admin/Student/deleteClass/sd_class/<?php echo ($list[0]["sd_class"]); ?>" 
									class="col-lg-1 col-lg-offset-1 btn btn-warning deleteWhole" onclick="javascript:return confirm('!!!你确定要删除<?php echo ($list[0]["sd_class"]); ?>班吗')">删除整班</a>-->
    ...
    <script src="<?php echo (ADMIN_PUBLIC); ?>/js/plugins/toastr/toastr.min.js"></script>
		 <script type="text/javascript">
        	navbar('.del_li','.del_li4');
        	if($('.marksClass').val() == 'marksClass'){
        		$('.deleteWhole').show();
        	}
    </script>
	</body>
