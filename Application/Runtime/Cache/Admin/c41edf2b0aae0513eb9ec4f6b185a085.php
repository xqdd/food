...
<div class="row border-bottom">
			...
			<li>
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                    	...
                    	<form action='/food/index.php/Admin/SC/search' class="form-horizontal" method="post">
                    	<div class="col-md-2">
                        ...
                        <form action='/food/index.php/Admin/SC/search' class="form-horizontal" method="post">
                    	<div class="col-md-2">
                    		<input type="text" name="sd_class" placeholder="按班别查找"class="form-control" required="">
                    	</div>
                    	<div class="col-md-2">
                    	<input type="submit" value="搜索" class="btn btn-primary">
                    	</div>
                        ...
                        <form action='/food/index.php/Admin/SC/search' class="form-horizontal" method="post">
                    	<div class="col-md-2">
                    	<input type="text" name="sd_num" placeholder="按学号查找"class="form-control" required="">
                    	</div>
                    	<div class="col-md-2">
                    	<input type="submit" value="搜索" class="btn btn-primary">
                    	</div>
				...
				<div class="wrapper wrapper-content animated fadeInRight">
						...
						<div class="col-lg-12">
							<div class="ibox float-e-margins">
								<div class="ibox-title">
									<h5>查询结果</h5>
									<span class="navhead1" style="display:none;font-size:15px;color:#000000">&nbsp;&nbsp;&nbsp;一共有<?php echo ($num); ?>名学生选了<?php echo ($arrayList[0]["ct_name"]); ?><font color="red">(只对精确查询有效)</font></span>
									<span class="navhead2" style="display:none;font-size:15px;color:#000000">&nbsp;&nbsp;&nbsp;<?php echo ($arrayList[0]["sd_class"]); ?>的选课情况<font color="red">(只对精确查询有效)</font></span>
									<span class="navhead3" style="display:none;font-size:15px;color:#000000">&nbsp;&nbsp;&nbsp;学号为<?php echo ($arrayList[0]["sd_num"]); ?>的学生一共选了<?php echo ($num); ?>门课<font color="red">(只对精确查询有效)</font></span>
					...
					<table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($arrayList)): $i = 0; $__LIST__ = $arrayList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td class="text-center"><?php echo ($i); ?></td>
                                <td class="text-center"><?php echo ($vo["sd_num"]); ?></td>  
                                <td class="text-center"><?php echo ($vo["sd_name"]); ?></td>
                                <td class="text-center"><?php echo ($vo["sd_sex"]); ?></td>
                                <td class="text-center"><?php echo ($vo["sd_class"]); ?></td>
                                <td class="text-center"><a href="/food/index.php/Admin/Content/showByID/ct_id/<?php echo ($vo["ct_id"]); ?>"><?php echo ($vo["ct_name"]); ?></a></td>
                                <td class="text-center"><?php echo ($vo["ct_teacher"]); ?></td>
						...
						<a href="/food/index.php/Admin/SC/expExcel" class="btn btn-primary" style="margin-left: 80%;">导出数据并生成excel</a>
								</div>
							</div>
						</div>
					</div>
    ...
    <script src="<?php echo (ADMIN_PUBLIC); ?>/js/plugins/toastr/toastr.min.js"></script>
		 <script type="text/javascript">
        	navbar('.select_li','.select_li5');
        	
        	if($('.marksContent').val() == 'marksContent'){
        		$('.navhead1').show();
        	}
        	if($('.marksContent').val() == 'marksClass'){
        		$('.navhead2').show();
        	}
        	if($('.marksContent').val() == 'marksNum'){
        		$('.navhead3').show();
        	}
