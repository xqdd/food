                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" id="form_data" name="form_data" enctype="multipart/form-data">
                                <div class="form-group"><label class="col-sm-4 control-label">选课开始时间:</label>
                                    <div class="col-sm-5">
                                    	<input type="text" name="dt_start_time" value="<?php echo (date('Y/m/d  H:m',$list["da_start_time"])); ?>" required="" class="form-control" id="datetimepicker"
                                ...
                                <div class="form-group"><label class="col-sm-4 control-label">选课结束时间:</label>
                                    <div class="col-sm-5"><input type="text" name="dt_end_time" value="<?php echo (date('Y/m/d  H:m',$list["da_end_time"])); ?>" required="" class="form-control" id="datetimepicker1"
                                    	onblur="checkDate()"/>
