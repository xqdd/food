...
<div class="row border-bottom">
		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					...
					<div class="col-lg-3">
						<h2></h2>
						<a class="btn btn-primary" href="/food/index.php/Admin/Announce/index">返回</a>
					</div>
				</div>
							...
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
									<form method="post" class="form-horizontal" enctype="multipart/form-data">
										<input type="hidden" name="an_id" value="<?php echo ($list["an_id"]); ?>">
										<div class="form-group">
											<label class="col-sm-2 control-label">标题:</label>
											<div class="col-sm-6">
												<input type="text" name="an_title" value="<?php echo ($list["an_title"]); ?>" placeholder="必填"  required="" class="form-control">
											</div>
										</div>
                                        ...
                                        <div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" name="an_summary" value="<?php echo ($list["an_summary"]); ?>" placeholder="选填" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-10 col-sm-offset-1">
												<textarea id="editor" name="an_content"></textarea>
											</div>
											<div id="an_content" style="display:none;"><?php echo ($list["an_content"]); ?></div>
										</div>
										<div class="hr-line-dashed"></div>
										<div class="form-group">
											<label class="col-sm-2 control-label">作者:</label>
											<div class="col-sm-3">
												<input type="text" name="an_author" value="<?php echo ($list["an_author"]); ?>" placeholder="选填" class="form-control">
											</div>
										</div>
	...
	<script type="text/javascript">
		...
		var atc_content = document.getElementById('an_content');
		var editor = UE.getEditor('editor');
		editor.addListener("ready", function() {
			// editor准备好之后才可以使用
			editor.setContent(an_content.innerHTML);
		});
		
		navbar('.select_li','.select_li7');
	</script>
