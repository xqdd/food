				 ...
				 <li role="presentation" ><a href="/food/index.php/Home/person/index">个人信息</a></li>
			 	 <li role="presentation" class="dropdown">
				   	 ...
				   	 <ul class="dropdown-menu" style="overflow: hidden;">
				   	 	<?php if(is_array($announce)): foreach($announce as $key=>$vo): ?><li><a href="/food/index.php/Home/Content/announce/an_id/<?php echo ($vo["an_id"]); ?>"><?php echo ($vo["an_title"]); ?></a></li><?php endforeach; endif; ?>
				    </ul>
			 	 </li>
