            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong class="breadcrumb_li3">所有课程内容</strong>
                        </li>
                    </ol>
                </div>
        	...
        	<div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>所有课程内容</h5>
                        <span style="margin-left: 10px;color:blue">您还可以发布：<?php echo ($sizeof); ?> 个课题！</span>
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th class="text-center">指定某系学生可选</th>
                                <th class="text-center">指导老师</th>
                                <th class="text-center">指导老师电话</th>
                                <th class="text-center">副指导老师</th>
                                <th class="text-center">选课情况</th>
                                <th class="text-center">学生信息</th>
                                <th class="text-center">拟安排实验室</th>
                            ...
                            <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td class="text-center"><?php echo ($vo["ct_name"]); ?></td>  
                                <td class="text-center"><?php echo ($vo["ct_faculty"]); ?></td>
                                <td class="text-center"><?php echo ($vo["ct_teacher"]); ?></td>
                                <td class="text-center"><?php echo ($vo["ct_phone"]); ?></td>
                                <td class="text-center"><?php echo ($vo["ct_fu_name"]); ?></td>
                                <td class="text-center">
                                	    <?php if(($vo["ct_seletctd_num"] == 1)): ?><span style="color:green">已被选</span>
									    <?php else: ?> <span style="color:red">未被选</span><?php endif; ?>
                                </td>
                                <td class="text-center">
                                 <?php if(($vo["ct_seletctd_num"] == 1)): ?><span style="color:green"><a href='/food/index.php/Teacher/Content/searchStu/ct_id/<?php echo ($vo["ct_id"]); ?>'>查看</a></span>
									    <?php else: ?> <span style="color:red"></span><?php endif; ?>
                                </td>
                                <td class="text-center"><?php echo ($vo["ct_lab"]); ?></td>
                                <td class="text-center">
                        <a class="btn btn-success btn-xs" href="/food/index.php/Teacher/Content/alert/ct_id/<?php echo ($vo["ct_id"]); ?>">修改</a> 
                        <a class="btn btn-warning btn-xs" href="/food/index.php/Teacher/Content/dele/ct_id/<?php echo ($vo["ct_id"]); ?>" onclick="javascript:return confirm('!!!你确定要删除&nbsp;&nbsp;<?php echo ($vo["ct_name"]); ?>这个课题吗？')">删除</a> 
                                </td>
