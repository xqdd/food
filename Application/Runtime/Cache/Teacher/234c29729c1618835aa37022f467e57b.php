    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-4">
                            ...
                            <tbody>
                            <tr>
                                <form action="/food/index.php/Teacher/Password/alert">
                                	
                                	<td class="text-center"><?php echo ($use['mg_name']); ?></td>
                                <td class="text-center"><input value="<?php echo ($use['mg_pwd']); ?>" name="mg_pwd"></td>
                                <td class="text-center"><input type="submit" value="确认修改" /></td>
                                </form>
                            </tr>
                            </tbody>
                        </table>
