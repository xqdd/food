	...
	<body class="gray-bg">
		<div class="middle-box text-center loginscreen animated fadeInDown">
			<div>
				...
				<h2>欢迎登陆-教师</h2>
				<form class="m-t" role="form" action="/food/index.php/Teacher/Login/index" method="post">
					...
					<div class="form-label col-md-6" style="width: 328px;margin-bottom: 30px;">
						<img src="/food/index.php/Teacher/Login/code" alt="验证码不见了？？" id="verify_img" onclick="this.src='/food/index.php/Teacher/Login/code/'+Math.random()" style="cursor: pointer;" title="看不清？点击更换另一个验证码。" />
					    <input type="text" name="captcha" class="form-control" placeholder="验证码" required="" style="float:left;width: 78px;margin-left: 63px;">
					</div>
				    <style>
				    	#verify_img{
				    		width: 156px;
					...
					<p style="color:red"><?php echo ($marks); ?></p>
				</form>
